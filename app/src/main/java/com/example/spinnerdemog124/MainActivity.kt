...
class MainActivity : AppCompatActivity(),AdapterView.OnItemSelectedListener {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //#1Create object to hold spinner
        val spinnerSelection : Spinner = findViewById(R.id.spinnerCourseSelection)
spinnerSelection.onItemSelectedListener = this
        //#2Create an ArrayAdapter using the string array and a default spinner layout
        ArrayAdapter.createFromResource(
            this,
            R.array.course_selection,
            android.R.layout.simple_spinner_item
        ).also { adapter ->
            //Specific the layout to use when the list of choices appears
    ...
    override fun onNothingSelected(parent: AdapterView<*>){
        ...
        val selectionTv : TextView = findViewById(R.id.SelectedCourseTextView)
        selectionTv.text = "You have not make a course selected"
    }
}